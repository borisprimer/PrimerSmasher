...
export const ROSTER: Fighter[] = [
  ...
  { id: 'Marta',     name: 'Marta',     photo: null,                            nationality: 'Poland',           flag: '🇵🇱', special: 'pierogi-pinwheel',  tier: 'easy' },
  ...
  { id: 'Ryan',      name: 'Ryan',      photo: null,                            nationality: 'South Africa',     flag: '🇿🇦', special: 'rooibos-rush',      tier: 'easy' },
